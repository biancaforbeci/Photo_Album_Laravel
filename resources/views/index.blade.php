...
<body>
          ...
          <form method="POST" action="/" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <div class="custom-file">
                  <input type="file" class="custom-file-input" id="arquivo" name="arquivo" accept="image/png, image/jpeg">
                      ...
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          ...
                          <form method="post" action="/{{$post->id}}">
                            @csrf
                            <!-- //enviando value delete com id para enviar para destroy no controller -->
    ...
    <footer class="text-muted">
      <div class="container">
        ...
        <p>©2019 Desenvolvedora Bianca</p>
      </div>
    </footer>
